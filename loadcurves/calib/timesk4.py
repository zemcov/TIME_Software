...
# TIME module (mux11) in Short Keck

# Modified 2020-01-24.  Validated to match TIME to ~5% by running the
# same detectors in run SK4 and 2019-10.
...
R_WIRES = 132 # Ohms (old measurement for Short Keck)
...
R_TBIAS = 400 # TES bias resistance (Sum of either R5 or R10 on bias card 3 and the 200 ohms on the MCE backplane. Verified on SBC-228 and backplane JRH 2015-12-07.)
...
# Not dual sided in SK
CAL_TES_BIAS_I = (V_TBIAS_MAX/(2**(BITS_TBIAS))) / (R_TBIAS + R_WIRES)
...
# Measured in Short Keck by Bryan on 2015-12-06
R_FB1_SERIES_BACKPLANE = 5000 # Ohms
