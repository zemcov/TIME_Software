...
def loadcurve_plotting(T, dir, i,cols=32, rows=33, auto=False):
    transition = False

    init_bias = np.load(f'/home/time_user/time_analysis/py/timefpu/bias_list_{T}.npy',allow_pickle=True) #This file relies on read load curves being run at least once
    import calib.time202001 as calib
