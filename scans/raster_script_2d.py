...
class TIME_TELE :
    ...
    # =================================================================================================================
        ...
        cmnd_list = ['TIME_START_TELEMETRY 1','TIME_START_TRACKING off','TIME_SCAN_TIME ' + str(sec),'TIME_MAP_SIZE ' + str(map_size),\
        ...
        while self.i < int(num_loop) :
            ...
            if self.i == 0 :
                ...
                self.pos_update()
                time.sleep((int(sec)+(int(sec)*0.05))*2) # because the dome needed 6-8 wraps for the first scan to warm up
