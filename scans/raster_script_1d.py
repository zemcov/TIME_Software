...
class TIME_TELE :
    ...
    def start_sock(self,queue2,queue,sec,map_size,map_len,map_angle,coord1,coord1_unit,coord2,coord2_unit,epoch,object,step,coord_space,step_unit,map_size_unit,map_len_unit,map_angle_unit,numloop):
    ...
    # =================================================================================================================
        ...
        cmnd_list = ['TIME_START_TELEMETRY 1','TIME_START_TRACKING off','TIME_SCAN_TIME ' + str(sec),'TIME_MAP_SIZE_EXTRA 1.1','TIME_MAP_SIZE ' + str(map_size),\
                        'TIME_MAP_ANGLE ' + str(map_angle),'TIME_MAP_COORD RA','TIME_SEEK ' + commands.format(coord1,coord2,epoch,object)]
        # cmnd_list = ['TIME_START_TELEMETRY 1']
        ...
        # time.sleep(int(sec)*numloop)
        print(colored(numloop,'yellow'))
