...
#----------------------------------------------------------
#import the data
f = mce_data.MCEfile('nameoffilehere') # filename will continuously update with new data
d = f.Read(row_col=True, unfilter='DC').data

trace = go.Heatmap(z=[[d[0,0], d[0,1], d[0,2], d[0,3], d[0,4], d[0,5], d[0,6], d[0,7]],
                   ...
                   x=['Column1', 'Column2', 'Column3', 'Column4', 'Column5','Column6','Column7','Column8'],
...
data=[trace]
py.iplot(data, filename='channel_rms_heatmap')
